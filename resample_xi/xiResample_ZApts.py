# run this as python FiducialZAPairCounting.py [tetsize] [simulation idx] [snapno] [xshift] [yshift] [zshift] [split]
...
mysplit = int(sys.argv[7])
newp = get_tet_interpolated_particles(Ndimtet,Loc3d_select_padded,split = mysplit)
newp = newp%Lbox
...
np.save(snapdir+"xiresampled_snap%03d_tet%d_%d%d%d_split%d_ZApts.npy"%(snapno,mytetsize,xshift,yshift,zshift,mysplit),xi_counts)
