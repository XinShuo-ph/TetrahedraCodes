...
outputdir = snapdir + "correlation_snap%03d_tet%d_N%d_x%d_y%d_z%d/"%(snapno,mytetsize,ngrid,xshift,yshift,zshift)
...
# read delta field
print("reading field")
rhos = np.load(snapdir+"fields_tet%d_z%f_shift%d%d%d.npy"%(mytetsize,currentz,xshift,yshift,zshift))
