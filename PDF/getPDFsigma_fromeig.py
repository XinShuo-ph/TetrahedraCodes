# compute sigma and PDF, for sim and ZA
# run this as getPDFsigma_fromeig.py [tetsize] [simno] [snapno] 
import numpy as np
import sys
import readgadget
...
print("got dens_vol")
eigenvalues_2idx=np.load(eigout)
print("got eigen")
...
if lambda_range[0]>-1:
    dm,rhobins=np.histogram(dens_vol,np.logspace(-1,1,200),density=True)
else:
