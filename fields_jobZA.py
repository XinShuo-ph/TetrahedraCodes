...
#remake the mesh
print("reading")
mypos = np.load(snapdir+"posZA_tet%d_z%f_shift%d%d%d.npy"%(mytetsize,currentz,xshift,yshift,zshift))
...
np.save(snapdir+"fieldsZA_tet%d_ngrid%d_z%f_shift%d%d%d.npy"%(mytetsize,int(sys.argv[6]),currentz,xshift,yshift,zshift),grid.fields["m"])
